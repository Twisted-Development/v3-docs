...
{% hint style="success" %}
QBCore uses lua tables to store static information instead of a database to prevent needing to execute queries. When you combine this with the ability to use [Broken link](broken-reference "mention") it can be a very powerful tool!
{% endhint %}
