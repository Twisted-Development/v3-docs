...
![Displays vehicle heath](../.gitbook/assets/unknown.png)

![Menu for mechanics to work on cars](<../.gitbook/assets/unknown (1).png>)

![Displays vehicle health in chat](<../.gitbook/assets/unknown (2) (1).png>)
